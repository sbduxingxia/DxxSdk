...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		switch (mode) {
			case PULL_FROM_END:
				inAnimResId = R.anim.zp_slide_in_from_bottom;
				outAnimResId = R.anim.zp_slide_out_to_bottom;
			...
			case PULL_FROM_START:
				inAnimResId = R.anim.zp_slide_in_from_top;
				outAnimResId = R.anim.zp_slide_out_to_top;
