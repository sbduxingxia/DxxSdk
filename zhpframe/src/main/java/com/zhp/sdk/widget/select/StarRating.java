package com.zhp.sdk.widget.select;
...
public class StarRating extends View {
    ...
    private OnRatingListener onStarChangeListener;//监听星星变化接口
    ...
    public StarRating(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        setClickable(true);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.StarRating);
        this.starDistance = (int) mTypedArray.getDimension(R.styleable.StarRating_starDistance, 0);
        this.starSize = (int) mTypedArray.getDimension(R.styleable.StarRating_starSize, 20);
        this.starCount = mTypedArray.getInteger(R.styleable.StarRating_starCount, 5);
        this.starEmptyDrawable = mTypedArray.getDrawable(R.styleable.StarRating_starEmpty);
        this.starFillBitmap = drawableToBitmap(mTypedArray.getDrawable(R.styleable.StarRating_starFill));
        this.integerMark = mTypedArray.getBoolean(R.styleable.StarRating_ratingInteger, true);
        mTypedArray.recycle();
    ...
    public void setStarMark(float mark) {
        ...
        if (this.onStarChangeListener != null) {
            this.onStarChangeListener.onRatingChange(this, starMark);  //调用监听接口
        }
        invalidate();
    }
     ...
     */
    public void setOnStarChangeListener(OnRatingListener onStarChangeListener) {
